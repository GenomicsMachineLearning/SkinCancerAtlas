...
output_dir <- '/scratch/project/stseq/Feng/projects/SkinCancerAtlas/Revision/manuscript_code/figS2'
...
# cell type
fov_cell_type_p <- plot_cell_boundary(nano.obj,fov_name='global',group_by='predicted.id',molecules=c("KRT15",'COL1A1'),
                            cols=unique_colour,is_legend=T,mols.size = 4,mols.cols=c('purple','yellow'))+
                        coord_flip()
